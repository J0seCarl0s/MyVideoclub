...
class CatalogController extends Controller
{
    ...
    public function getIndex(){
        return view('catalog.index')->with('arrayFilms', $this->arrayPeliculas);
    }

    public function getShow($id){
    	return view('catalog.show')->with('film', $this->arrayPeliculas[$id]);
    }

    public function getEdit($id){
    	return view('catalog.edit')->with('film', $this->arrayPeliculas[$id]);
    }
